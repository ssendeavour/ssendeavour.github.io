...
nmap ,is :IHS:A
nmap ,ih :IHS
noremap ,cpb :CtrlPBuffer
noremap ,cpf :CtrlP
noremap ,cpr :CtrlPMRU
noremap ,cpm :CtrlPMixed
noremap ,tr :NERDTreeCWD
noremap ,tf :NERDTreeFind	
noremap ,nerd :NERDTree
map ,cd :cd %:p:h :pwd
map ,ee :e ~/.vimrc
map <silent> , :nohl
map Q gq
...
set fileencodings=utf8,GB18030,utf-16le,utf-16,big5,latin1
...
silent only
cd ~/Dropbox/documents/blog/github
...
exe '2resize ' . ((&lines * 6 + 21) / 42)
exe '3resize ' . ((&lines * 12 + 21) / 42)
argglobal
edit /usr/share/vim/vim74/doc/version5.txt
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let s:l = 2094 - ((9 * winheight(0) + 10) / 20)
